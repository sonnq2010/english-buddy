...
class WebRTCService extends getx.GetxController {
  static final WebRTCService _instance = getx.Get.put(WebRTCService());
  ...
  final currentConnectionState =
      getx.Rx(RTCPeerConnectionState.RTCPeerConnectionStateNew);
